...
<!-- end UberMenu CSS -->
	...
	function optionsMenu(){
		...
		$sparkOps->addTextarea( $styleConfig,
					...
					__( 'Best for minor CSS tweaks.  Want to write a custom style?  Use custom.css.  <br/><br/><span class="spark-infobox">These styles will be applied regardless of the options above</span>', 'ubermenu' ),
					''
					);
		...
		$sparkOps->addInfobox( $styleGen, 
					...
					__( 'Please note that unless you set the <strong>Style Application</strong> to <strong>Style Generator</strong> '.
						'in <em>UberMenu > Style Configuration</em>, these settings will have no effect.', 'ubermenu' ),
